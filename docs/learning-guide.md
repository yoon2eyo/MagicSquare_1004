...
| **산출물** | [`docs/spec/validate_lines.md`](spec/validate_lines.md) |
...
3. **R-G-I-O 표 작성** — [`docs/spec/validate_lines.md`](spec/validate_lines.md) §3
4. **계약 표 작성** — 동 문서 §4
5. **Mom Test → 설계 매핑** — 동 문서 §2
6. **C2C 설계표** — 동 문서 §5 (PRD → To-Do → TC)
...
**spec SSOT:** [`docs/spec/validate_lines.md`](spec/validate_lines.md)

### R-G-I-O (validate_lines)

> 전문은 [spec 산출물 §3](spec/validate_lines.md#3-r-g-i-o) 참고.
...
> 전문·C2C·TC 목록: [spec 산출물 §4·§5](spec/validate_lines.md#4-함수-계약--validate_lines)
...
- [spec — validate_lines 설계](spec/validate_lines.md)
